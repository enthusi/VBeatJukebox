...
;----------------------------------------------------
        EVEN 4
_COL_PTR0        
        LIBBIN song7/col_ptr0.dat
        EVEN 4
_COL_PTR1        
        LIBBIN song7/col_ptr1.dat
        EVEN 4
_COL_PTR2
        LIBBIN song7/col_ptr2.dat
        EVEN 4
_COL_PTR3        
        LIBBIN song7/col_ptr3.dat
        EVEN 4
_COL_PTR4        
        LIBBIN song7/col_ptr4.dat
        EVEN 4
_COL_PTR5        
        LIBBIN song7/col_ptr5.dat

;----------------------------------------------------        
        EVEN 4
_COL_OFFSETS0
        LIBBIN song7/col_offsets0.dat
        EVEN 4
_COL_OFFSETS1
        LIBBIN song7/col_offsets1.dat
        EVEN 4
_COL_OFFSETS2
        LIBBIN song7/col_offsets2.dat
        EVEN 4
_COL_OFFSETS3
        LIBBIN song7/col_offsets3.dat
        EVEN 4
_COL_OFFSETS4
        LIBBIN song7/col_offsets4.dat
        EVEN 4
_COL_OFFSETS5
        LIBBIN song7/col_offsets5.dat        
;----------------------------------------------------
...
_CHANNEL0
        LIBBIN song7/channel0_stream4.dat
       ; EVEN 4
_CHANNEL1
        LIBBIN song7/channel1_stream4.dat        
       ; EVEN 4
_CHANNEL2
        LIBBIN song7/channel2_stream4.dat        
        ;EVEN 4
_CHANNEL3
        LIBBIN song7/channel3_stream4.dat
        ;EVEN 4
_CHANNEL4
        LIBBIN song7/channel4_stream4.dat        
        ;EVEN 4
_CHANNEL5
        LIBBIN song7/channel5_stream4.dat        
...
_instrument_nsnare ;05 endless clone vol 16 22
    db 1, VOL | WAVE, 15, 1
	db 0

_instrument_nchh ;05 endless clone vol 32 23
    db 1, VOL | WAVE, 31, 1
	db 0

_instrument_nohh ;05 endless clone vol 48 24
    db 1, VOL | WAVE, 47, 1
	db 0
...
_MY_WAVE_0
        ...
        EVEN 4
_PLAYLIST
        LIBBIN song7/VBDemo01_playlist.bin
        db  $ff ;end marker
