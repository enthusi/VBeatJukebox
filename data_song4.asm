...
;----------------------------------------------------
        EVEN 4
_COL_PTR0        
        LIBBIN song4/col_ptr0.dat
        EVEN 4
_COL_PTR1        
        LIBBIN song4/col_ptr1.dat
        EVEN 4
_COL_PTR2
        LIBBIN song4/col_ptr2.dat
        EVEN 4
_COL_PTR3        
        LIBBIN song4/col_ptr3.dat
        EVEN 4
_COL_PTR4        
        LIBBIN song4/col_ptr4.dat
        EVEN 4
_COL_PTR5        
        LIBBIN song4/col_ptr5.dat

;----------------------------------------------------        
        EVEN 4
_COL_OFFSETS0
        LIBBIN song4/col_offsets0.dat
        EVEN 4
_COL_OFFSETS1
        LIBBIN song4/col_offsets1.dat
        EVEN 4
_COL_OFFSETS2
        LIBBIN song4/col_offsets2.dat
        EVEN 4
_COL_OFFSETS3
        LIBBIN song4/col_offsets3.dat
        EVEN 4
_COL_OFFSETS4
        LIBBIN song4/col_offsets4.dat
        EVEN 4
_COL_OFFSETS5
        LIBBIN song4/col_offsets5.dat        
;----------------------------------------------------
...
_CHANNEL0
        LIBBIN song4/channel0_stream4.dat
       ; EVEN 4
_CHANNEL1
        LIBBIN song4/channel1_stream4.dat        
       ; EVEN 4
_CHANNEL2
        LIBBIN song4/channel2_stream4.dat        
        ;EVEN 4
_CHANNEL3
        LIBBIN song4/channel3_stream4.dat
        ;EVEN 4
_CHANNEL4
        LIBBIN song4/channel4_stream4.dat        
        ;EVEN 4
_CHANNEL5
        LIBBIN song4/channel5_stream4.dat        
...
_instrument_nsnare ;24 nohh clone V08 22
    db 1, HARDNOTE | VOL | WAVE, 80, 0, 2, $81
	db 1, HARDNOTE | VOL | WAVE, 60, 0, 2, $81
	db 3, VOL, 2
	db 6, VOL, 2
	db 6, VOL, 2
	db 9, VOL, 2
...
_instrument_nchh ;24 nohh clone V16 23
    db 1, HARDNOTE | VOL | WAVE, 80, 0, 4, $81
	db 1, HARDNOTE | VOL | WAVE, 60, 0, 4, $81
	db 3, VOL, 4
	db 6, VOL, 4
	db 6, VOL, 4
	db 9, VOL, 2
...
_instrument_short_tri ;24 nohh clone V24 26
    db 1, HARDNOTE | VOL | WAVE, 80, 0, 8, $81
	db 1, HARDNOTE | VOL | WAVE, 60, 0, 8, $81
	db 3, VOL, 8
	db 6, VOL, 8
	db 6, VOL, 4
	db 9, VOL, 2
...
_instrument_short_saw ;24 nohh clone V32 27
    db 1, HARDNOTE | VOL | WAVE, 80, 0, 10, $81
	db 1, HARDNOTE | VOL | WAVE, 60, 0, 10, $81
	db 3, VOL, 10
	db 6, VOL, 8
	db 6, VOL, 4
	db 9, VOL, 2
...
_instrument_endless_squ ;24 nohh clone V40 29
    db 1, HARDNOTE | VOL | WAVE, 80, 0, 12, $81
	db 1, HARDNOTE | VOL | WAVE, 60, 0, 12, $81
	db 3, VOL, 12
	db 6, VOL, 8
	db 6, VOL, 4
	db 9, VOL, 2
...
_instrument_strings_squ ;24 nohh clone V48 30
    db 1, HARDNOTE | VOL | WAVE, 80, 0, 14, $81
	db 1, HARDNOTE | VOL | WAVE, 60, 0, 14, $81
	db 3, VOL, 12
	db 6, VOL, 8
	db 6, VOL, 4
	db 9, VOL, 2
...
_MY_WAVE_0
        ...
        EVEN 4
_PLAYLIST
        LIBBIN song4/VBDemo01_playlist.bin
        db  $ff ;end marker
